...
- `usage-brief` explains current usage and the customer benefit a proposed change could create, including efficiency and reliability. It can post a PR or ticket comment after confirmation.

The skills use the `novus` MCP server. Invoke them directly or ask naturally for a Build Value report, UX review, usage brief, next-work decision, or portfolio investment review.
